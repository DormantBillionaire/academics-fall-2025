...
%---------------------------------
\node[fancytitle, right=10pt] at (box.north west) {Constants To Know };
\end{tikzpicture}
...
%------------ campo titulo---------------------
\node[fancytitle, right=10pt] at (box.north west) {Chapter 8 PPT Problems};
\end{tikzpicture}
%---------------------------------
%\bigskip
%---------------------------
...
%---------------------------------
\node[fancytitle, right=10pt] at (box.north west) {Chapter 9 PPT Problems};
\end{tikzpicture}
